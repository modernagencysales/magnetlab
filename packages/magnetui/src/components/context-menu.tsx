...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRight size={iconSize.sm} strokeWidth={iconStrokeWidth} className="ml-auto" />
  </ContextMenuPrimitive.SubTrigger>
));
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-lg border bg-popover p-1 text-popover-foreground shadow-dropdown',
