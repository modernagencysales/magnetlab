  ...
  "node_modules/agentkeepalive/lib/agent.js"(exports, module) {
    ...
    var Agent = class extends OriginalAgent {
      ...
      createConnection(options, oncreate) {
        let called = false;
        const onNewCreate = /* @__PURE__ */ __name((err, socket) => {
          if (called) return;
          called = true;
          if (err) {
    ...
    __name(getSocketTimeout, "getSocketTimeout");
...
var FormDataEncoder = class {
  ...
  *values() {
  ...
  }, "_FormDataEncoder_getFieldHeader"), Symbol.iterator)]() {
    return this.values();
  }
...
async function fileFromPath2(path, ...args) {
  const { fileFromPath: _fileFromPath } = await import("./fileFromPath-C6IYKUWK.mjs");
...
__name(getMultipartRequestOptions2, "getMultipartRequestOptions");
function getRuntime() {
  ...
  return {
    ...
    getDefaultAgent: /* @__PURE__ */ __name((url) => url.startsWith("https") ? defaultHttpsAgent : defaultHttpAgent, "getDefaultAgent"),
    fileFromPath: fileFromPath2,
    isFsReadStream: /* @__PURE__ */ __name((value) => value instanceof FsReadStream, "isFsReadStream")
  };
}
...
var PromptCachingBetaMessageStream = class _PromptCachingBetaMessageStream {
  ...
  constructor() {
    ...
    __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_connectedPromise, "f").catch(() => {
    });
    __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_endPromise, "f").catch(() => {
    });
  }
  /**
  ...
  _run(executor) {
    executor().then(() => {
      this._emitFinal();
      this._emit("end");
    }, __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_handleError, "f"));
  }
  ...
  async _createPromptCachingBetaMessage(messages, params, options) {
    ...
    __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_instances, "m", _PromptCachingBetaMessageStream_beginRequest).call(this);
    const stream = await messages.create({ ...params, stream: true }, { ...options, signal: this.controller.signal });
    this._connected();
    for await (const event of stream) {
      __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_instances, "m", _PromptCachingBetaMessageStream_addStreamEvent).call(this, event);
    }
    if (stream.controller.signal?.aborted) {
      throw new APIUserAbortError();
    }
    __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_instances, "m", _PromptCachingBetaMessageStream_endRequest).call(this);
  }
  _connected() {
    if (this.ended)
      return;
    __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_resolveConnectedPromise, "f").call(this);
    this._emit("connect");
  }
  get ended() {
    return __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_ended, "f");
  }
  get errored() {
    return __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_errored, "f");
  }
  get aborted() {
    return __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_aborted, "f");
  }
  abort() {
    this.controller.abort();
  }
   ...
   */
  on(event, listener) {
    const listeners = __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_listeners, "f")[event] || (__classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_listeners, "f")[event] = []);
   ...
   */
  off(event, listener) {
    const listeners = __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_listeners, "f")[event];
    if (!listeners)
      return this;
  ...
  async done() {
    __classPrivateFieldSet3(this, _PromptCachingBetaMessageStream_catchingPromiseCreated, true, "f");
    await __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_endPromise, "f");
  }
  get currentMessage() {
    return __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_currentMessageSnapshot, "f");
  }
  /**
  ...
  async finalMessage() {
    await this.done();
    return __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_instances, "m", _PromptCachingBetaMessageStream_getFinalMessage).call(this);
  }
  /**
  ...
  async finalText() {
    await this.done();
    return __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_instances, "m", _PromptCachingBetaMessageStream_getFinalText).call(this);
  }
  _emit(event, ...args) {
    if (__classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_ended, "f"))
      return;
    if (event === "end") {
      __classPrivateFieldSet3(this, _PromptCachingBetaMessageStream_ended, true, "f");
      __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_resolveEndPromise, "f").call(this);
    }
    const listeners = __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_listeners, "f")[event];
    if (listeners) {
      __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_listeners, "f")[event] = listeners.filter((l) => !l.once);
      listeners.forEach(({ listener }) => listener(...args));
    }
    if (event === "abort") {
      const error = args[0];
      if (!__classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_catchingPromiseCreated, "f") && !listeners?.length) {
        Promise.reject(error);
      }
      __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_rejectConnectedPromise, "f").call(this, error);
      __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_rejectEndPromise, "f").call(this, error);
      this._emit("end");
      return;
    }
    if (event === "error") {
  ...
  _emitFinal() {
    ...
    if (finalPromptCachingBetaMessage) {
      this._emit("finalPromptCachingBetaMessage", __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_instances, "m", _PromptCachingBetaMessageStream_getFinalMessage).call(this));
    }
  }
  ...
  [(_PromptCachingBetaMessageStream_currentMessageSnapshot = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_connectedPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_resolveConnectedPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_rejectConnectedPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_endPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_resolveEndPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_rejectEndPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_listeners = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_ended = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_errored = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_aborted = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_catchingPromiseCreated = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_handleError = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_instances = /* @__PURE__ */ new WeakSet(), _PromptCachingBetaMessageStream_getFinalMessage = /* @__PURE__ */ __name(function _PromptCachingBetaMessageStream_getFinalMessage2() {
    ...
    if (this.ended)
      return;
    const messageSnapshot = __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_instances, "m", _PromptCachingBetaMessageStream_accumulateMessage).call(this, event);
    ...
    const snapshot = __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_currentMessageSnapshot, "f");
    if (!snapshot) {
    ...
    let snapshot = __classPrivateFieldGet4(this, _PromptCachingBetaMessageStream_currentMessageSnapshot, "f");
...
var MessageStream = class _MessageStream {
  ...
  constructor() {
    ...
    __classPrivateFieldGet5(this, _MessageStream_connectedPromise, "f").catch(() => {
    });
    __classPrivateFieldGet5(this, _MessageStream_endPromise, "f").catch(() => {
    });
  }
  /**
   * Intended for use on the frontend, consuming a stream produced with
  ...
  _run(executor) {
    executor().then(() => {
      this._emitFinal();
      this._emit("end");
    }, __classPrivateFieldGet5(this, _MessageStream_handleError, "f"));
  }
  ...
  async _createMessage(messages, params, options) {
    ...
    __classPrivateFieldGet5(this, _MessageStream_instances, "m", _MessageStream_beginRequest).call(this);
    const stream = await messages.create({ ...params, stream: true }, { ...options, signal: this.controller.signal });
    this._connected();
    for await (const event of stream) {
      __classPrivateFieldGet5(this, _MessageStream_instances, "m", _MessageStream_addStreamEvent).call(this, event);
    }
    if (stream.controller.signal?.aborted) {
      throw new APIUserAbortError();
    }
    __classPrivateFieldGet5(this, _MessageStream_instances, "m", _MessageStream_endRequest).call(this);
  }
  _connected() {
    if (this.ended)
      return;
    __classPrivateFieldGet5(this, _MessageStream_resolveConnectedPromise, "f").call(this);
    this._emit("connect");
  }
  get ended() {
    return __classPrivateFieldGet5(this, _MessageStream_ended, "f");
  }
  get errored() {
    return __classPrivateFieldGet5(this, _MessageStream_errored, "f");
  }
  get aborted() {
    return __classPrivateFieldGet5(this, _MessageStream_aborted, "f");
  }
  abort() {
    this.controller.abort();
  }
   ...
   */
  on(event, listener) {
    const listeners = __classPrivateFieldGet5(this, _MessageStream_listeners, "f")[event] || (__classPrivateFieldGet5(this, _MessageStream_listeners, "f")[event] = []);
    listeners.push({ listener });
    return this;
  }
  /**
   ...
   */
  off(event, listener) {
    const listeners = __classPrivateFieldGet5(this, _MessageStream_listeners, "f")[event];
    if (!listeners)
      return this;
    const index = listeners.findIndex((l) => l.listener === listener);
    if (index >= 0)
  ...
  async done() {
    __classPrivateFieldSet4(this, _MessageStream_catchingPromiseCreated, true, "f");
    await __classPrivateFieldGet5(this, _MessageStream_endPromise, "f");
  }
  get currentMessage() {
    return __classPrivateFieldGet5(this, _MessageStream_currentMessageSnapshot, "f");
  }
  /**
  ...
  async finalMessage() {
    await this.done();
    return __classPrivateFieldGet5(this, _MessageStream_instances, "m", _MessageStream_getFinalMessage).call(this);
  }
  /**
  ...
  async finalText() {
    await this.done();
    return __classPrivateFieldGet5(this, _MessageStream_instances, "m", _MessageStream_getFinalText).call(this);
  }
  _emit(event, ...args) {
    if (__classPrivateFieldGet5(this, _MessageStream_ended, "f"))
      return;
    if (event === "end") {
      __classPrivateFieldSet4(this, _MessageStream_ended, true, "f");
      __classPrivateFieldGet5(this, _MessageStream_resolveEndPromise, "f").call(this);
    }
    const listeners = __classPrivateFieldGet5(this, _MessageStream_listeners, "f")[event];
    if (listeners) {
      __classPrivateFieldGet5(this, _MessageStream_listeners, "f")[event] = listeners.filter((l) => !l.once);
      listeners.forEach(({ listener }) => listener(...args));
    }
    if (event === "abort") {
      const error = args[0];
      if (!__classPrivateFieldGet5(this, _MessageStream_catchingPromiseCreated, "f") && !listeners?.length) {
        Promise.reject(error);
      }
      __classPrivateFieldGet5(this, _MessageStream_rejectConnectedPromise, "f").call(this, error);
      __classPrivateFieldGet5(this, _MessageStream_rejectEndPromise, "f").call(this, error);
      this._emit("end");
      return;
    }
    if (event === "error") {
  ...
  _emitFinal() {
    ...
    if (finalMessage) {
      this._emit("finalMessage", __classPrivateFieldGet5(this, _MessageStream_instances, "m", _MessageStream_getFinalMessage).call(this));
    }
  }
  async _fromReadableStream(readableStream, options) {
    const signal = options?.signal;
  ...
  [(_MessageStream_currentMessageSnapshot = /* @__PURE__ */ new WeakMap(), _MessageStream_connectedPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_resolveConnectedPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_rejectConnectedPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_endPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_resolveEndPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_rejectEndPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_listeners = /* @__PURE__ */ new WeakMap(), _MessageStream_ended = /* @__PURE__ */ new WeakMap(), _MessageStream_errored = /* @__PURE__ */ new WeakMap(), _MessageStream_aborted = /* @__PURE__ */ new WeakMap(), _MessageStream_catchingPromiseCreated = /* @__PURE__ */ new WeakMap(), _MessageStream_handleError = /* @__PURE__ */ new WeakMap(), _MessageStream_instances = /* @__PURE__ */ new WeakSet(), _MessageStream_getFinalMessage = /* @__PURE__ */ __name(function _MessageStream_getFinalMessage2() {
    ...
    if (this.ended)
      return;
    const messageSnapshot = __classPrivateFieldGet5(this, _MessageStream_instances, "m", _MessageStream_accumulateMessage).call(this, event);
    this._emit("streamEvent", event, messageSnapshot);
    switch (event.type) {
      case "content_block_delta": {
        const content = messageSnapshot.content.at(-1);
    ...
    const snapshot = __classPrivateFieldGet5(this, _MessageStream_currentMessageSnapshot, "f");
    if (!snapshot) {
      throw new AnthropicError(`request ended without sending any chunks`);
    }
    __classPrivateFieldSet4(this, _MessageStream_currentMessageSnapshot, void 0, "f");
    ...
    let snapshot = __classPrivateFieldGet5(this, _MessageStream_currentMessageSnapshot, "f");
    if (event.type === "message_start") {
      if (snapshot) {
        throw new AnthropicError(`Unexpected event order, got ${event.type} before receiving "message_stop"`);
      }
...
// src/lib/ai/content-pipeline/anthropic-client.ts
init_esm();
...
function getAnthropicClient() {
  if (!anthropicClient) {
    ...
    anthropicClient = new sdk_default({ apiKey, timeout: 24e4 });
  }
...
// src/lib/ai/content-pipeline/model-config.ts
init_esm();
var CLAUDE_SONNET_MODEL = "claude-sonnet-4-20250514";
...
humanize-ms/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HJL3WNPY.mjs.map
