...
/** Insert pro subscription (for external create-account). */
export async function insertProSubscription(userId: string): Promise<void> {
  ...
  if (error) throw new Error(`subscription.insertProSubscription: ${error.message}`);
}
