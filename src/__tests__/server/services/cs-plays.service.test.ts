...
describe('cs-plays.service', () => {
  ...
  describe('getPlayById', () => {
    ...
    it('promotion_suggestion is "promote" when testing + avg>=5 + low variance', async () => {
      mockFindPlayById.mockResolvedValue({ ...mockPlay, status: 'testing' });
      mockCountSignals.mockResolvedValue(2);
      mockFindResults.mockResolvedValue([
        { multiplier: 6, niche: 'saas' },
        { multiplier: 7, niche: 'saas' },
        { multiplier: 5, niche: 'b2b' },
      ]);
    ...
    it('promotion_suggestion is "decline" when proven + recent avg < 2', async () => {
      mockFindPlayById.mockResolvedValue({ ...mockPlay, status: 'proven' });
      mockCountSignals.mockResolvedValue(2);
      mockFindResults.mockResolvedValue([
        { multiplier: 1, niche: 'saas' },
        { multiplier: 1.5, niche: 'saas' },
        { multiplier: 1, niche: 'b2b' },
        { multiplier: 0.8, niche: 'b2b' },
    ...
    it('promotion_suggestion is null with < 3 results', async () => {
      mockFindPlayById.mockResolvedValue({ ...mockPlay, status: 'testing' });
