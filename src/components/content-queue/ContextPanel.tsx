...
/**
 * ContextPanel.
 * Right column of the editing view — tabbed between AI copilot and context info.
 * AI tab (default): inline copilot for editing posts via chat.
 * Context tab: writing style, content brief, AI review notes, and post stats.
    ...
    <div className="flex w-[260px] shrink-0 flex-col border-l border-border bg-muted">
      ...
      {activeTab === 'ai' && (
        <InlineCopilot
          ...
          reviewData={currentPost?.review_data ?? null}
          onContentUpdated={onContentUpdated}
        />
      )}

      {/* Context tab — scrollable content */}
      {activeTab === 'context' && (
