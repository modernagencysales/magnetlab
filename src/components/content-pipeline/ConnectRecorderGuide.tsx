...
const TOOLS: RecorderTool[] = [
  {
    ...
    makeUrl: 'https://apps.make.com/fathom',
    method: 'both',
    steps: [
      'Open Zapier and create a new Zap',
      'Trigger: Fathom → "New transcript from a meeting"',
      'Action: Webhooks by Zapier → POST to your webhook URL below',
      'Map: recording_id → recording ID, transcript → transcript text, title → meeting title',
      'Set source to "fathom" in the JSON body',
      'Turn on the Zap',
    ],
    notes: 'Fathom also supports native webhooks — go to Settings → Webhooks and add your URL. Check "Include transcript" when configuring.',
  },
  {
    id: 'otter',
    name: 'Otter.ai',
