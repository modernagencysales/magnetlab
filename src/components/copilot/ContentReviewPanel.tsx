...
export function ContentReviewPanel({
  ...
  }, [isOpen, editingField, isRequestingChanges, onClose]);
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* ── Sticky Header ─────────────────────────────────────── */}
            <header className="sticky top-0 z-10 flex items-center justify-between gap-4 border-b border-zinc-200 dark:border-zinc-800 bg-background/80 backdrop-blur-md px-6 py-4">
