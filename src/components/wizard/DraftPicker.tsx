  ...
  return (
    <div className="space-y-6">
        ...
        {drafts.map((draft) => (
          ...
          >
            <Button
              ...
              className="absolute right-3 top-3 opacity-0 transition-opacity hover:bg-destructive/10 hover:text-destructive group-hover:opacity-100"
            ...
            <button onClick={() => onSelect(draft)} className="w-full text-left">
              <div className="flex items-start gap-3">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                  <FileText className="h-5 w-5" />
                </div>
                <div className="min-w-0 flex-1">
                  <h3 className="truncate font-medium">{draft.draft_title || 'Untitled Draft'}</h3>
      ...
      <Button
        variant="outline"
        onClick={onStartNew}
        className="flex w-full items-center justify-center gap-2 border-2 border-dashed border-muted-foreground/25 py-4 h-auto hover:border-primary/50 hover:text-primary"
      >
