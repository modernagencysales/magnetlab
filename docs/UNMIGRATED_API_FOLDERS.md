...
| Folder | Routes | Tables / notes |
|--------|--------|-----------------|
| external/lead-magnets | ~~GET, POST, [id], [id]/extract, [id]/generate, [id]/write-posts, [id]/stats, ideate~~ ✅ all migrated | - |
| external/funnels | ~~GET, POST, [id]/publish~~ ✅ all migrated | - |
| external/* | ~~create-lead-magnet, create-account, setup-thankyou, ingest-transcript, import-posts, ingest-knowledge, generate-quiz, review-content, apply-branding~~ ✅ all migrated | - |
...
| public/* | ~~view, resource-click, page/[username]/[slug], questions/[id], lead, chat~~ ✅ all migrated | - |
...
- **Step 10 (done):** external (create-lead-magnet, create-account, setup-thankyou, ingest-transcript, import-posts, ingest-knowledge, generate-quiz, review-content, apply-branding), external/funnels (GET, POST, [id]/publish), external/lead-magnets ([id]/extract, [id]/generate, [id]/write-posts, [id]/stats, ideate), public/lead (POST, PATCH), public/chat (GET, POST)
